...
urlpatterns = [
    ...
    url( r'^resources/labs/$', views.proxy, name='proxy_url' ),
    url( r'^presources/labs/doubletree-data.txt/$', views.proxy_doubletree, name='proxy_doubletree_url' ),
    url( r'^resources/labs/(?P<slug>.*)/$', views.proxy, name='proxy_param_url' ),
