    ...
    if (this.status == 200) {
      ...
      $("li.biblToRetrieve").each(function () {
        ...
        try {
          ...
          console.log('Catch error here 1!')
        ...
        if (bibliographies[b].url) new_html += "<a style='display:inline;' href='" + bibliographies[b].url + "'>Link to Full Entry</a>";

        bspan.innerHTML = new_html;
        console.log('bspan.innerHTML', bspan.innerHTML);
